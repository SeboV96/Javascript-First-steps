...
span.innerHTML = span.innerHTML + " Sebastian"
...
buildToDos(toDoItems).forEach(elemento => {
...
if (e.key === 'Enter') addToDo() // metodo para que tambien funcione la tecla ENTER cuando ingresas una tarea
  })
displayToDos()
}
